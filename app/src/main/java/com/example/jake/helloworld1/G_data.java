...
public final class G_data {
    ...
    static {
        ...
        addProduct("", "Cinnamon Danish", "Viggo Mortensen. Covered in cinnamon", 1.80);
        addProduct("", "Pecan Danish", "Hamlet, lightly sprinkled in pecans", 1.90);
        addProduct("", "Apple Danish", "Lars von Trier made of apples", 1.80);
        addProduct("", "Fruit Danish", "Don't know any more Danish people, you're on your own", 1.80);
